...
var EmojiDrawer = class {
  ...
  particleInit(_container, particle) {
    ...
    const padding = emojiOptions.padding * double18, maxSize = getRangeMax(particle.size.value), fullSize = maxSize + padding, canvasSize = fullSize * double18;
    let image;
