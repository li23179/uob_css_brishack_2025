...
async function loadEasingBackPlugin(engine, refresh = true) {
    ...
    await engine.addEasing(engine_1.EasingType.easeInBack, value => {
        const c1 = 1.70158, c3 = c1 + 1;
        return c3 * value ** 3 - c1 * value ** 2;
    }, false);
    await engine.addEasing(engine_1.EasingType.easeOutBack, value => {
        const c1 = 1.70158, c3 = c1 + 1;
        return 1 + c3 * Math.pow(value - 1, 3) + c1 * Math.pow(value - 1, 2);
    }, false);
    await engine.addEasing(engine_1.EasingType.easeInOutBack, value => {
