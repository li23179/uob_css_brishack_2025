(function (factory) {
    ...
    async function loadAll(engine, refresh = true) {
        ...
        await (0, interaction_external_particle_1.loadExternalParticleInteraction)(engine, false);
        ...
        await (0, shape_infinity_1.loadInfinityShape)(engine, false);
